...
WL.ClientMessages = {
    ...
    directUpdateNotificationTitle : 'Update Is Available',
    directUpdateNotificationMessage : 'An update for the application is available (file size {0} MB).',
    ...
    downloadAppWebResourcesAppIdNotExist : 'Application "{0}" cannot be found. Deploy it first to the Worklight Server.',
    ...
    downloadAppWebResourcesAppVersionNotExist : 'Cannot find app "{0}" {1} for {2}',
    ...
    notificationUpdateFailure : 'Failed registering for push notifications. The application will not be able to receive notifications.',
    notAvailable : 'Not Available',
    // o
    ok : 'OK',
    osxReloadGadget : 'The application needs to be reloaded',
    osxReloadGadgetInstructions : 'Please click CMD+R in order to reload the application.',
    // p
    password : 'Password:',
    // q
    // r
