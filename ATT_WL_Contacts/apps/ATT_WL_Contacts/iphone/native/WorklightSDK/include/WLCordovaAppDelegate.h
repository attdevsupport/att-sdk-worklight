...
/**
 WLCordovaAppDelegate is the base Worklight hybrid application class implementing the UIApplicationDelegate protocol.
 When developing a Worklight hybrid application you should extend the WLCordovaAppDelegate class to utilize the Worklight framework API.
